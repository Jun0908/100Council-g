...
const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || '0xb8ed7e349796c3c445d79185e2cd3209b2461700'; //Poygon testnet

//const RPC_URL = process.env.RPC_URL;
const RPC_URL = process.env.POL_TEST_RPC_URL;
