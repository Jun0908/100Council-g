...
const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || "0x4ab6bb0302e767591e2ca464e375fc40561d9c0a"; //Polygon_Testnet

// Setup ethers provider and signer
//const provider = new ethers.JsonRpcProvider(process.env.RPC_URL);
const provider = new ethers.JsonRpcProvider(process.env.POL_TEST_RPC_URL);
