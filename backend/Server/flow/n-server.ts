...
const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || "0xF257752512cC50320e030BA78C79a7f5aeaFFC5C"; //Flow_Testnet

// Setup ethers provider and signer
//const provider = new ethers.JsonRpcProvider(process.env.RPC_URL);
const provider = new ethers.JsonRpcProvider(process.env.FLOW_TEST_RPC_URL);
