...
const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || '0x2e9CF33DEcE4FE50283ABBdE02440a7DAAB6a170'; //FLOW testnet

//const RPC_URL = process.env.RPC_URL;
const RPC_URL = process.env.FLOW_TEST_RPC_URL;
