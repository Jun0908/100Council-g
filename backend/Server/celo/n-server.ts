...
//const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || "0x0ae1ebf61c2fe2ee0bb80696ab51ac455045f012";
const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || "0xd758a520b53d401577ec4b70df30feaad32c8699"; //CELO_Testnet
//const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || "0xe2a548dacdbc942d659a523fd40335000c80064c"; //CELO_Mainnet

// Setup ethers provider and signer
//const provider = new ethers.JsonRpcProvider(process.env.RPC_URL);
const provider = new ethers.JsonRpcProvider(process.env.CELO_TEST_RPC_URL);
