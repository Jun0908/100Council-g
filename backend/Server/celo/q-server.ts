...
const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || '0xe2a548dacdbc942d659a523fd40335000c80064c'; //CELO testnet
//const CONTRACT_ADDRESS = process.env.CONTRACT_ADDRESS || '0x1440a247071edde7e1016b18126163d805f98c31'; //CELO mainnet
//const RPC_URL = process.env.RPC_URL;
const RPC_URL = process.env.CELO_TEST_RPC_URL;
